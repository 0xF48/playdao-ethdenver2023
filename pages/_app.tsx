...
function DebugHeader() {
  ...
  return <div className='w-full px-5 flex flex-col items-start content-start text-sm text-gray-500 my-3 max-w-full overflow-hidden'>
    ...
    <span>playdao contract = {PLAYDAOGlobals().DAO_CONTRACT}</span>
    <span>badge contract = {PLAYDAOGlobals().BADGE_CONTRACT}</span>
    <span>chain_id = {PLAYDAOGlobals().CHAIN_ID}</span>
  </div>
}
