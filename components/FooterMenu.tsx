...
export default function () {
	return <div className="w-full p-4 flex items-center content-center justify-center fixed bottom-0 left-0 pointer-events-none">
		<div className='w-auto h-16 bg-black rounded-2xl text-white flex flex-row pointer-events-all relative px-0'>
			<div className="h-full px-6 flex items-center content-center justify-center">
				<MenuIcon></MenuIcon>
			</div>
			<div className="h-full px-6 flex items-center content-center justify-center">
				<BadgeIcon></BadgeIcon>
